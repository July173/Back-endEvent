...
public class RegisterDTO {
    ...
    public long getNumberIdentification() { return numberIdentification; }
    public void setNumberIdentification(long numberIdentification) { this.numberIdentification = numberIdentification; }
